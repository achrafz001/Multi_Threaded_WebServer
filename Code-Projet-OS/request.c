...
//the request handle is responsible for dealing with Requests : Errors, Static/Dynamic, Security
void request_handle(int fd) {
    ...
    //security considerations: to ensure that pathnames passed in do not refer to files outside of the sub-tree.
	if(strstr(filename,".."))
	    {
